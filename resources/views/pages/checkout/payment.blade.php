...
<section id="cart_items">
		<div class="container">
					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{URL::to('public/uploads/sanpham/'.$v_content->options->image)}}" width="80" alt="" /></a>
							</td>
							<td class="cart_description">
								<h4><a href="">{{$v_content->name}}</a></h4>
								<p>Đây là sản phẩm khuyến mãi</p>
							</td>
							<td class="cart_price">
			...
			<div class="payment-options">
					...
					<span>
						<label><input name="payment_option" value="2" type="checkbox"> Thanh toán bằng tiền mặt khi nhận hàng</label>
					</span>
					<span>
